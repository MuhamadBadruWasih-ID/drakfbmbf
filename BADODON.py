#Decompiled by MR.MUHAMAD BADRU WASIH
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtu.be/A7-wH4sQzbg')
                time.sleep(2)
                menu()
